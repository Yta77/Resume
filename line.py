...
df = pd.read_csv("C:\\Users\\Workstation2\\Desktop\\Dash Input\\COMED_hourly.csv")  # https://drive.google.com/file/d/1jyvSiRjaNIeOCP59dUFQuZ0_N_StiQOr/view?usp=sharing
df['giornora'] = pd.to_datetime(df['giornora'])
...
def build_graph(first_cuisine, second_cuisine, third_cuisine):
    ...
    fig.update_layout(yaxis={'title':'NEGATIVE POINT'},
                      title={'text':'Hourly Load Consuption',
